...
class LanguageController(private val languageService: LanguageService) {
    ...
    @PostMapping
    fun createLanguage(@RequestBody languageRequest: Language) = languageService.createLanguage(languageRequest)

    @PutMapping("/{languageId}")
    fun updateLanguage(@PathVariable languageId: Int, @RequestBody languageRequest: Language) =
        languageService.updateLanguage(languageId, languageRequest)
